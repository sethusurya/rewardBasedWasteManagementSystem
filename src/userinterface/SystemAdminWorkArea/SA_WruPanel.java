...
public class SA_WruPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(28, 260, 120, 22));

        lblPassword.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblPassword.setText("Admin Password : ");
        add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 320, 130, 22));

        txtName.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 260, 163, 38));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 110, -1));

        lblStreetAddress.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblStreetAddress.setText("Street Address : ");
        add(lblStreetAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 320, 110, 22));

        txtStreet.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtStreet, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, 163, 38));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 89, 680, 141));
        ...
        add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 90, 84, -1));

        lblUsername.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblUsername.setText("Admin UserName : ");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 270, -1, 22));

        txtCity.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, 163, 38));

        txtUsername.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 260, 163, 38));

        lblCity.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCity.setText("City : ");
        add(lblCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 370, 98, 22));

        txtZip.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtZip, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 430, 163, 38));

        lblZip.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblZip.setText("Zip : ");
        add(lblZip, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 98, 22));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 520, 84, -1));

        title.setFont(new java.awt.Font("Helvetica", 1, 18)); // NOI18N
        title.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        title.setText("WASTE RECYCLING UNITS");
        add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 30, 320, 40));

        txtPassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, 163, 38));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/WRU_all.png"))); // NOI18N

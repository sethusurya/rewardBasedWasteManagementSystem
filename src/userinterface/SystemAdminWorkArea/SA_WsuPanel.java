...
public class SA_WsuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(txtCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 370, 163, 38));
        ...
        add(txtZip, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 163, 38));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 530, 130, -1));

        title.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        title.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        title.setText("WASTE SEGREGATING UNITS");
        add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 42, 900, 40));
        ...
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 163, 38));
        ...
        add(lblStreetAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 320, 130, 22));

        txtStreet.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtStreet, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 163, 38));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 88, 668, 141));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 190, -1, -1));
        ...
        add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 90, 84, -1));

        lblUsername.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblUsername.setText("Admin UserName : ");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 130, 22));

        txtUsername.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 260, 163, 38));

        lblPassword.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblPassword.setText("Admin Password : ");
        add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 330, -1, 22));

        txtPassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 320, 163, 38));
